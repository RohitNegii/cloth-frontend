...
const comingSoonCollections = collectionsData.filter(
  (c) => c.status === "soon"
);
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-[var(--text-secondary)] max-w-3xl mx-auto">
            Explore our curated collections, designed to elevate your style for
            every season.
          </p>
        </motion.div>
        ...
        <div className="relative w-full h-[60vh] rounded-2xl overflow-hidden shadow-2xl group mb-10">
          ...
          >
            <h3 className="text-4xl lg:text-5xl font-bold tracking-tight text-shadow-md">
              {activeCollection.name}
            </h3>
            <p className="mt-4 text-lg text-gray-200 max-w-lg text-shadow-sm">
        ...
        <div className="text-center mb-12">
          <h3 className="text-3xl font-bold text-[var(--primary-brand)]">
            Coming Soon
          </h3>
