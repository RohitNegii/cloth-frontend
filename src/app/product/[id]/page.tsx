...
const relatedProducts = [
  ...
  },
  {
    ...
    price: "₹2,799",
    imageUrl:
      "https://images.unsplash.com/photo-1621072156002-e2f31c197e41?auto=format&fit=crop&w=600&q=80",
    ctaLink: "/product/3",
  },
  {
    id: 4,
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        // Initialize state with first values from API response
  ...
  return (
    <Layout>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col justify-center">
              <h1 className="text-4xl md:text-5xl font-extrabold mb-2 text-[var(--primary-brand)]">
                {product.name}
              </h1>
              <div className="flex items-center mb-4">
                <div className="flex items-center">
                  {[...Array(5)].map((_, i) => (
                    // Renders solid star if index is less than the floor of the rating (e.g., 4 solid stars for 4.8)
                    <FaStar
                      key={i}
                      className={
                ...
                {/* 🎯 Displays the denormalized review count from the API response 🎯 */}
                <p className="text-[var(--text-secondary)] ml-2">
                  ({product.reviews} reviews)
                </p>
              </div>
              <p className="text-3xl font-bold text-[var(--primary-brand)] mb-6">
                ${product.price}
              </p>
      ...
      <div className="bg-[var(--contrast-light-2)] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-[var(--primary-brand)] mb-8">
            Related Items
          </h2>
